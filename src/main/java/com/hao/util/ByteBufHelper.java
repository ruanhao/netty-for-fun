...
public class ByteBufHelper {
    ...
    public static void printAll(ByteBuf buffer) {
        int length = buffer.readableBytes();
        int rows = length / 16 + (length % 15 == 0 ? 0 : 1) + 4;
        StringBuilder buf = new StringBuilder(rows * 80 * 2)
                .append("[").append(buffer.getClass().getSimpleName()).append("] ")
                .append("read index:").append(buffer.readerIndex()).append(", ")
                .append("write index:").append(buffer.writerIndex()).append(", ")
                .append("refcnt: ").append(buffer.refCnt()).append(", ")
                .append("capacity:").append(buffer.capacity()).append("/").append(buffer.maxCapacity())
                .append(NEWLINE);
